      ...
      <div className="h-screen bg-white  mt-2 sm:px-6 sm:py-2 flex flex-col">
        <div className="flex flex-col gap-6  items-left flex-grow max-h-full">
          <div className="flex flex-col justify-center items-center ">
            <h1 className=" text-2xl mx-auto sm:text-4xl font-semibold text-black bg-clip-text pt-2 ">
              Chat With PDF
            </h1>
          ...
          <div className="w-[100%] flex flex-col self-center items-center">
            ...
            <div className="mx-auto flex sm:flex-row  flex-col">
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row" >
                <input type="file" name="file"   onChange={(e) => setFile(e.target.files?.[0])} className={` ${submitted?"hidden":""} file:cursor-pointer my-2  text-xs sm:text-sm file:text-sm file:py-1 sm:file:py-3 file:px-4 file:rounded-full file:text-white file:shadow-none   file:bg-[#d6506b] file:hover:bg-[#d6506b] file:border-none`}/>
                
                <input type="submit" value='Submit' className={` ${submitted?"hidden":""} doc-upload-button cursor-pointer bg-white border border-[#d6506b] text-[#d6506b] font-semibold my-2 py-1 sm:py-3 px-8 text-sm rounded-full`}/>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="w-auto max-w-xl break-words bg-white rounded-b-xl rounded-tr-xl text-black p-6 border border-gray-100 ">
                          <p className="text-xs sm:text-sm font-medium text-[#d6506b] mb-2">
                            AI assistant
                          </p>
                          {message.content}
